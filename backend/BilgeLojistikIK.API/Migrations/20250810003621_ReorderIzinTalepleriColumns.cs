...
namespace BilgeLojistikIK.API.Migrations
{
    ...
    public partial class ReorderIzinTalepleriColumns : Migration
    {
        ...
        {
            // PostgreSQL'de sütun sırasını değiştirmek için tablo yeniden oluşturulmalı
            migrationBuilder.Sql(@"
                ...
                CREATE TABLE izin_talepleri (
                    ...
                    izin_tipi VARCHAR(50) NOT NULL DEFAULT 'Yıllık İzin',
                    aciklama TEXT,
                ...
                -- Foreign key constraint'leri yeniden oluştur
