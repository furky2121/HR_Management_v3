...
namespace BilgeLojistikIK.API.Migrations
{
    ...
    public partial class FixIzinTalepleriColumnMapping : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // izin_baslama_tarihi'ni isbasi_tarihi (eski baslangic_tarihi) ile değiştir
            migrationBuilder.Sql("UPDATE izin_talepleri SET izin_baslama_tarihi = isbasi_tarihi");

            // isbasi_tarihi'ni geçici sütundaki verilerle değiştir
        ...
        {
            // Geri alma işlemi - sütunları tekrar değiştir
            migrationBuilder.AddColumn<DateTime>(
                name: "temp_column",
                table: "izin_talepleri",
                type: "timestamp with time zone",
